...
if __name__ == "__main__":
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):
        ...
        print_nvidia_smi() # call occasionally in training loop
    ...
    # python train2.py --dataroot ./datasets/facades --name facades_pix2pix_mixed --model pix2pix --direction BtoA  --batch_size 8 --input_nc 3 --output_nc 3
    # python -m torch.distributed.launch --nproc_per_node=2 train2.py --dataroot ./datasets/facades --name facades_pix2pix_mixed --model pix2pix --direction BtoA --batch_size 8